...
from accounts.views import UserListView, UserDetailView, CurrentUserView, FollowingListView, toggle_follow, upload_avatar, upload_banner

urlpatterns = [
    path('users/', UserListView.as_view(), name='user-list'),
    path('users/me/', CurrentUserView.as_view(), name='user-me'),
    path('users/me/avatar/', upload_avatar, name='avatar-upload'),
    path('users/me/banner/', upload_banner, name='banner-upload'),
